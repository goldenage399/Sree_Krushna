...
```mermaid
flowchart LR
    V["Vision & Shot List<br/>(MED-xxx)"] 
    --> S["Day-of Coverage<br/>(Traditional + Candid + Drone)"]
    --> R["Raw Footage Ingestion<br/>(Hard Drive Custody)"]
    --> T["Teaser & Highlight Reel<br/>(Review & Approval)"]
    --> A["Master Album & 4K Film<br/>(07_DOCUMENTS_ARCHIVE)"]
```
