...
### The Opening Pitch:
> *"Hey Sree, to make sure our wedding planning is 100% stress-free, fun, and completely aligned with what we both want, I’ve set up our own personal 'Wedding Control Center'. It keeps all our dates, decor moodboards, vendor quotes, and day-of schedules in one clean place so we never have to stress over forgotten details or miscommunications with vendors and family!"*
...
*$\rightarrow$ Record outputs into [`00_GOVERNANCE/vision_and_principles.md`](file:///d:/GitHub_Repo/Sree_Krushna/00_GOVERNANCE/vision_and_principles.md) and [`08_RESEARCH_REFERENCE/inspiration_boards/`](file:///d:/GitHub_Repo/Sree_Krushna/08_RESEARCH_REFERENCE/inspiration_boards/).*
...
*$\rightarrow$ Record outputs into [`04_PROCUREMENT_VENDORS/attire_and_jewellery/`](file:///d:/GitHub_Repo/Sree_Krushna/04_PROCUREMENT_VENDORS/attire_and_jewellery/).*
...
*$\rightarrow$ Record outputs into [`04_PROCUREMENT_VENDORS/photography/`](file:///d:/GitHub_Repo/Sree_Krushna/04_PROCUREMENT_VENDORS/photography/).*
...
*$\rightarrow$ Record outputs into [`04_PROCUREMENT_VENDORS/food_and_catering/`](file:///d:/GitHub_Repo/Sree_Krushna/04_PROCUREMENT_VENDORS/food_and_catering/).*
...
1. **Create an Action Item (`TSK-###`):** Add it directly via the interactive console or tell me, e.g.:
   - *"Book MUA trial with Studio X for next Sunday"* $\rightarrow$ creates `TSK-008` (Owner: Sree).
