/**
 * Static Decoupled Component Assembler (SDCA) - Shopping & Trousseau Data Layer Builder
 * Standard: SPEC-PROC-TROUSSEAU-001 / P-SHOPPING-CONSENSUS-001 / P-COMPARE-SHARE-001
 * Ruling: AC-DEC-2026-018 / UI-DEC-2026-014
 * 
 * Generates both js/shopping-data.js and public/js/shopping-data.js with 100% byte parity.
 */
  ...
  clusters: [
    {
      ...
      deciders: ["Bride", "In-Laws", "Sisters"],
    ...
    },
    {
      ...
      deciders: ["Groom", "In-Laws", "Sisters"],
    ...
    },
    {
      ...
      deciders: ["Groom Parents", "Groom Sisters", "In-Laws"],
  ...
  stores: [
    {
      ...
      recommendedFor: ["TRS-BR-01", "TRS-GR-01", "TRS-GR-02", "TRS-SA-01"],
    ...
    },
    {
      ...
      recommendedFor: ["TRS-JW-01", "TRS-JW-02", "TRS-JW-04", "TRS-JW-05", "TRS-JW-07", "TRS-JW-08"],
    ...
    },
    {
      ...
      recommendedFor: ["TRS-JW-01", "TRS-JW-03", "TRS-JW-06", "TRS-JW-09"],
      timings: "10:30 AM - 08:30 PM"
    },
    {
      ...
      recommendedFor: ["TRS-BR-02", "TRS-BR-05", "TRS-SA-04"],
    ...
    },
    {
      ...
      recommendedFor: ["TRS-GR-03", "TRS-GR-04", "TRS-GR-05", "TRS-GR-07", "TRS-SA-03"],
      timings: "10:30 AM - 09:00 PM"
    },
    {
      ...
      recommendedFor: ["TRS-GR-03", "TRS-GR-04", "TRS-GR-08"],
    ...
    },
    {
      ...
      recommendedFor: ["TRS-BR-06", "TRS-GR-08", "TRS-JW-08", "TRS-SA-05"],
    ...
    },
    {
      ...
      recommendedFor: ["TRS-GR-06", "TRS-SA-02"],
      timings: "10:30 AM - 08:30 PM"
    }
  ],
  items: [
    // Category A: Bridal
    {
      ...
      status: "Shortlisted",
      approvals: { bride: true, sisters: true, inlaws: true }
    },
    {
      id: "TRS-BR-02",
      code: "BR-02",
      ...
      status: "Shortlisted",
      approvals: { bride: true, sisters: true, inlaws: false }
    },
    {
      id: "TRS-BR-03",
      code: "BR-03",
      ...
      status: "Planned",
      approvals: { bride: true, sisters: false, inlaws: false }
    },
    {
      id: "TRS-BR-04",
      code: "BR-04",
    ...
    },
    {
      ...
      status: "Planned",
      approvals: { bride: false, sisters: false, inlaws: true }
    },
    {
      id: "TRS-BR-06",
      code: "BR-06",
    ...
    },
    {
      ...
      status: "Planned",
      approvals: { bride: false, sisters: true, inlaws: false }
    },
    ...
    },
    {
      ...
      status: "Planned",
      approvals: { bride: true, sisters: false, inlaws: true }
    },
    {
      id: "TRS-GR-03",
      code: "GR-03",
...
window.SHOPPING_REGISTRY_DATA = ${JSON.stringify(shoppingData, null, 2)};
`;

const target1 = path.join(rootDir, 'js/shopping-data.js');
const target2 = path.join(rootDir, 'public/js/shopping-data.js');
...
console.log('✅ Successfully wrote updated Shopping Data layer to:');
