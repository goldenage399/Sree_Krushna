...
const itemEventMap = {
  ...
  'DEC-13': { event: 'wedding', plateRef: 'PLATE-06', plateTitle: 'Ceremonial Seating Typography & Concourse Clearance' },
  ...
  'DEC-15': { event: 'infrastructure', plateRef: 'PLATE-07', alternativePlates: ['PLATE-08'], plateTitle: '20×8ft Rectangular Central Island & Dual Main Buffet' },
  ...
  'PROP-EXP-001': { event: 'haldi', plateRef: 'PLATE-05', plateTitle: 'Haldi Outdoor Rain Dance & Splash Deck with 3-Stage Air-Lock' },
  'PROP-EXP-002': { event: 'mehendi', plateRef: 'PLATE-08', plateTitle: 'Artisanal Ittar & Live Lac Bangle Craft Rotunda' },
  'PROP-EXP-003': { event: 'infrastructure', plateRef: 'PLATE-07', plateTitle: 'Elder Foot Spa & Reflexology Lounge' },
  'PROP-EXP-004': { event: 'sangeet', plateRef: 'PLATE-03', plateTitle: '360° Glam-Cam & Retro Rotary Audio Guestbook' },
  'PROP-EXP-005': { event: 'infrastructure', plateRef: 'PLATE-07', plateTitle: 'Theatrical Nitro Dessert Counter & Live Culinary Theater' },
  'PROP-EXP-006': { event: 'wedding', plateRef: 'PLATE-05', plateTitle: 'Grand Barat Procession & Cold-Pyro Sparkler Avenue' },
  'PROP-EXP-007': { event: 'infrastructure', plateRef: 'PLATE-07', plateTitle: 'Acoustic Decoupling Drapery for 30ft VIP Dining Pod' },
